locals {
    ...
    private_subnets           = var.create_cluster ? module.vpc.private_subnets : data.aws_subnet.private_subnets[*]
    public_subnet_ids         = var.create_cluster ? module.vpc.public_subnets_ids : var.public_subnet_ids
    public_subnets            = var.create_cluster ? module.vpc.public_subnets : data.aws_subnet.public_subnets[*]
