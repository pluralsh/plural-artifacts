...
*/}}
{{- define "lightdash-plural.fullname" -}}
...
Common labels
*/}}
{{- define "lightdash-plural.labels" -}}
helm.sh/chart: {{ include "lightdash-plural.chart" . }}
{{ include "lightdash-plural.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "lightdash-plural.selectorLabels" -}}
app.kubernetes.io/name: {{ include "lightdash-plural.name" . }}
...
*/}}
{{- define "lightdash-plural.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "lightdash-plural.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "lightdash.database.sslmode" -}}
