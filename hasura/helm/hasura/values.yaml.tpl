...
hasura:
  init:
    ...
    {{ if gt (len $splitName) 2 }}
      ...
      password: {{ dedupe . "hasura.hasura.init.adminUser.password" (randAlphaNum 26) }}
    {{ end }}
  ingress:
    hosts:
    - {{ .Values.hostname }}
  ...
  configOverrides:
    plural_oidc: |
      import jwt
      from hasura.security import hasuraSecurityManager
      from flask_appbuilder.security.manager import AUTH_OAUTH

      class PluralSecurityManager(hasuraSecurityManager):
