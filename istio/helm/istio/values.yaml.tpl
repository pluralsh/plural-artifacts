...
monitoring:
  ...
  tracing:
    tempoNamespace: {{ namespace "grafana-tempo" | default "grafana-tempo" }}
...
kiali-server:
  ...
  external_services:
    ...
    {{  end }}
    tracing:
      in_cluster_url: http://grafana-tempo-tempo-distributed-query-frontend.{{ namespace "grafana-tempo" | default "grafana-tempo" }}:16686
